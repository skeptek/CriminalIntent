...
public class CrimeCameraFragment extends Fragment { 
	...
	private Camera.PictureCallback mJpegCallback = new Camera.PictureCallback() {
		...
		public void onPictureTaken(byte[] data, Camera camera) {
			...
			// Set the phot filename on the result intent
			if (success) {
				Intent i = new Intent();
	...
	/** A simple algorithm to get the largest size available.  For a better version 
	 * see CameraPreview.java in the ApiDemos sample app from Android
	 */
	private Size getBestSupportedSize(List<Size> sizes, int width, int heigiht) {
